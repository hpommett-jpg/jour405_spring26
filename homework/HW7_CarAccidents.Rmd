...
ANSWER HERE – There appear to be periods where accidents trend higher, likely late spring/summer, and lower, which could possibly be winter. This suggests a seasonal driving pattern. Some days show dramatic increases or decreases compared to surrounding days, indicating possible weather events, holidays, or data anomalies. Questions that could be investigated based on the data includes if it was COVID that had an effect on the data in 2020, or if weather patterns could be examined in the area to better understand the spikes and drops. A story angle about the weather could be "How Major Weather Triggered Accident Surges." Another story angle on COVID could be "2020: The Safest Year for Accidents in PG County."
...
ANSWER HERE Typically, Fridays and Saturdays have the highest average accidents, while Sundays tend to have the lowest. This could be due to society's general lack of schedule and routine on the weekends, with people frequently traveling, driving family around, or adults having the chance to drink alcohol. 
...
accidents <- accidents |>
  mutate(
    mean_accidents = mean(total, na.rm = TRUE),
    sd_accidents = sd(total, na.rm = TRUE),
...
ANSWER HERE One of the most unusual high-accident days likely coincides with the Halloween weekend. This could be due to the rise in travel, people walking on the street, or alcohol and drug consumption by drivers. This could be confirmed by police reports and court records, genuine and relaible sources, into the story. 
...
accidents <- accidents |>
  group_by(day_of_week) |>
  mutate(
    dow_mean = mean(total, na.rm = TRUE),
    dow_sd = sd(total, na.rm = TRUE),
...
ANSWER HERE The overall extreme z-scores identify days that are unusual compared to the entire dataset, while the day-of-the-week data shows specific days with accidents that stood out compared to the mean. While Fridays tend to have higher crash rates, a Monday with Friday-level crashes would stand out in the day-of-the-week adjusted analysis.A good insight to consider is what is actually out of the norm, which are predictable, versus truly abnormal stats. 
...
ANSWER HERE The months with the highest averages are the last three, October, November, and December, as well as May. The spike may occur in May October, with the ending and beginning of the local school year. People may have trouble adjusting to the new traffic schedule with and without buses on the roads. November and December make sense as well, as people must adjust to the onset of ice and snow in the area and are traveling for the holidays. The months with the lowest accidents are January and March, which may have to do with many people staying inside for winter breaks in January and spring breaks in March. 
...
ANSWER HERE The extreme outliers in the mix all occur on holiday weekends, and Friday and Saturday in general. 
...
With the onslaught of travel and slippery weather throughout November and December, accident rates have been shown to skyrocket in comparison to the rest of the year. In order to keep safe, awareness of the data and upcoming weather are imperative to remaining vigilant on the roads. 

Some things I could examine for this story are why crash totals rise sharply in the last three months of the year, how earlier sunsets affect evening commute safety, the impact of holiday shopping traffic and family travel.
I could speak with the Prince George’s County Police Department traffic safety officials, Maryland State Highway Administration representatives, or local meteorologists. 
