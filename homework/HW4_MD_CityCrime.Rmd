...
```{r}
md_cities_analysis <- md_cities %>%
  mutate(
    violent_rate_2020 = (violent_2020 / population_2020) * 1000,
    property_rate_2020 = (property_2020 / population_2020) * 1000,
    pct_change_total = ((grand_total_2020 - grand_total_2019) / grand_total_2019) * 100
  )
```
