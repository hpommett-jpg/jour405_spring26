...
The correlation does not seem strong, given the miniscule decimal presented after calculation. This conclusion is only reinforced by the scatterpolot, showing the most variable difference directly in the middle where games had 0 goal difference and a large range of fouls per game. 


### Task 7: Choose another variable and repeat steps in Task 4-5, thendescribe the result
```{r}

```

I chose the corner kicks correlation; there does seem to be a level of correlation, though nothing hugely significant. The number of cornerkicks allowed in a game does appear to have an impact on winning chances, though it does not make or break the game. 
