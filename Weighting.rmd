...
1. What is the range of weights in this dataset?The range is from the minimum of 0.23 to the maximum 3.04

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? If the respondent has a weight of 0.23 it means they are largely overrepresented in the sample; the dataset already has many of these types of respondents. A respondent with the weight of 3.04 is underrepresented; their response is only representative of about 3 people, which infleunces the sample.

3. Why might some respondents be weighted more heavily than others? Not all people are bound to answer a study, so weighing helps to balance results and correct the underrepresentation. 
...
1. Which voter category shows the biggest difference between weighted and unweighted results? The rarely/never category shows the biggest shift between weighted and unweighted results.

2. How might these differences affect reporting on likely voter turnout? These differences can really affect reporting on voter turnout; reporting on unweighted data can overestimate turnout, showing more voters' participation than reality.  

3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample? Some groups are more likely to respond to surveys, or more comfortable responding to them. The sample likely overrepresents more engaged or optimistic respondents, and can underrepresent more engaged populations. 
