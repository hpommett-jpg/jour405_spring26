...
```{r}
ggplot(pg_murders, aes(x = temperature, y = murders, label = month)) +
  geom_point()
```
...
murders |>
  ggplot() +
gg_point(aes(x=murders,y=temperature)) +
...
The correlation calculation is in the middle, showing at 58%. This kind of matches the scatterplot, with warmer months typically going above 30 murders. However, December was still on the higher side of murders, 
