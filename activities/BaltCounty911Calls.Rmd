...
ANSWER HERE
Not to only highlight unusual days, but a pattern I notice is that the highest points in the chart include the midway points of seasons. The largest numbers are all in the midpoints of spring, summer, fall, and winter. I also notice the number goes up around holidays, with a soar of overdose calls near Halloween and New Year's. 
...
ANSWER HERE These unusual days in this chart are highlighted using different colors dedicated for unusually high versus unusualy low, allowing the viewer to easily identify the outliers in the chart. This can be important in chart analysis for quick identification of deviant numbers.
...
ANSWER HERE October 4th, 2022 experienced an extremely high overdose call rate, in comparison with other days throughout the year. This day led to the highest volume of 911 calls in the entire year relating to drug overdoses, ultiamtely to be blamed by an increase in fentanyl in throughout the region. 
...
ANSWER HERE Some potential angles for reporting include exploring the drug use rates in Baltimore County throughout the years and if this is related to gang-affiliated drug rings near the city, or speaking to police and first responders on the scene that day or people who survived and recovered from the incident and have since gotten clean, and reporting their stories. 
